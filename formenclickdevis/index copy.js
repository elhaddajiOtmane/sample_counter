...
const popupSelectElement = document.querySelector("div.wgl_custom-col-12:nth-child(5) > span:nth-child(1) > select:nth-child(1)");
const popupQuantityInput = document.querySelector("#popupQuantity-list");
const popupPricUnite = document.querySelector("#popupQuantity-list");
const popupTotalInput=document.querySelector("#popuptotalq");

//  [calculated calculated-203 cf7_hide "menu-choices * number-358 * 0.1"]
const popupTvaPrice = document.querySelector("#tvaprice");

const popupTotalInputttc = document.querySelector("#popuptotalinputttc");
